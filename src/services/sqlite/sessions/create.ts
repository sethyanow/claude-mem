 ...
 * Fixes Issue #846 where observations fail after worker restart because the
...
/**
 * Get or create a manual session for a project.
 * Manual sessions are used for non-SDK operations (e.g., manual imports).
 */
