/**
 * SDKUtils: Configuration helpers for the Claude Agent SDK
 *
 * Extracted from SDKAgent to reduce file size.
 * These are SDK-specific utilities not shared with Gemini/OpenRouter agents.
 */
...
/**
 * Find Claude executable (checked once per session)
 * Uses execSync with hardcoded commands (no user input) — safe from injection.
 */
