...
import { executeFindByFile } from './search/find-by-file.js';
import { executeMultiSearch } from './search/multi-search.js';
import { executeTimeline } from './search/timeline-handler.js';
import { executeContextTimeline } from './search/context-timeline.js';
import { executeQueryTimeline } from './search/query-timeline.js';
...
export class SearchManager {
  ...
  async search(args: any): Promise<any> {
    return executeMultiSearch(args, {
      normalizeParams: (a: any) => this.normalizeParams(a),
      queryChroma: (q: string, l: number, f?: Record<string, any>) => this.queryChroma(q, l, f),
      chromaAvailable: !!this.chromaSync,
  ...
  async getContextTimeline(args: any): Promise<any> {
    return executeContextTimeline(args, {
      sessionStore: this.sessionStore,
      timelineService: this.timelineService,
    });
  }
  ...
  async getTimelineByQuery(args: any): Promise<any> {
    return executeQueryTimeline(args, {
      queryChroma: (q: string, l: number, f?: Record<string, any>) => this.queryChroma(q, l, f),
      chromaAvailable: !!this.chromaSync,
      sessionStore: this.sessionStore,
      timelineService: this.timelineService,
